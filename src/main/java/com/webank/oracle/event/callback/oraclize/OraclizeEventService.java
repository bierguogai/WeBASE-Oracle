...
import static com.webank.oracle.transaction.oraclize.OracleCore.LOG1_EVENT;
...
@Slf4j
@Service
public class OraclizeEventService {
    ...
    public void registerContractEvent() {
        ...
        for (int i = 0; i < eventRegisterList.size(); i++) {
            ...
            OraclizeContractEventCallback callBack = new OraclizeContractEventCallback(oracleService, reqHistoryRepository, decoder, eventRegister.getChainId(), eventRegister.getGroup());
